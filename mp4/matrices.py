    ...
    def __init__(self, *args, **kwargs):
        ...
        if isinstance(args[0], (list, tuple)):
            ...
            if len(args) == 1:
                ...
                self.__rows = args[0]
                self.__cols = args[1]
        elif isinstance(args[0], self.ctx.matrix):
            A = args[0].copy()

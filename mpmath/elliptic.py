...
from functions import (pi, sqrt, cos, sin, exp, ellipk, sech, nthroot)
...
# in the first form
# jacobi_theta_1(z, m),..., jacobi_theta_4(z, m)
# are functions of the complex variable z and of the parameter m;
# in the second form
# jacobi_theta(n, z, q), n = 1,...,4
# z and q are complex variables, with q within the unit disk.
...
def jacobi_elliptic_sn(u, m):
    ...
    if m == zero:
        ...
        v3 = jacobi_theta(3, zero, q)
        v2 = jacobi_theta(2, zero, q)        # mathworld says v4

        arg1 = u / (v3*v3)

        v1 = jacobi_theta(1, arg1, q)
        v4 = jacobi_theta(4, arg1, q)
...
def jacobi_elliptic_cn(u, m):
    ...
    if m == zero:
        ...
        v3 = jacobi_theta(3, zero, q)
        v2 = jacobi_theta(2, zero, q)
        v04 =jacobi_theta(4, zero, q)

        arg1 = u / (v3*v3)

        v1 = jacobi_theta(2, arg1, q)
        v4 = jacobi_theta(4, arg1, q)

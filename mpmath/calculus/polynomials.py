...
def polyroots(ctx, coeffs, maxsteps=50, cleanup=True, extraprec=10,
    ...
    **Examples**
    ...
    the roots of `x^5 - 1`::
        ...
        ...
        1.0
        (-0.809016994374947424102+0.5877852522924731291685j)
        (-0.809016994374947424102-0.5877852522924731291685j)
        (0.3090169943749474241023+0.9510565162951535721165j)
        (0.3090169943749474241023-0.9510565162951535721165j)
    ...
    **Precision and conditioning**
    ...
    typically compute all roots of an arbitrary polynomial to high precision::
        ...
        ...     print(r)
        ...
        -3.1462643699419723423291350657155704455124771291873287012324868
        -0.31783724519578224472575761729617428837313337843343255487912724
        0.31783724519578224472575761729617428837313337843343255487912724
        3.1462643699419723423291350657155704455124771291873287012324868
        >>>
        >>> sqrt(3) + sqrt(2)
        3.1462643699419723423291350657155704455124771291873287012324868
        >>> sqrt(3) - sqrt(2)
        0.31783724519578224472575761729617428837313337843343255487912728

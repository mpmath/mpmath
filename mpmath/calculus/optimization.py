...
def findroot(ctx, f, x0, solver='secant', tol=None, verbose=False, verify=True,
    ...
    **Examples**
    ...
    (or else it will never leave the real line)::
        ...
        (0.22669882575820188+1.4677115087102244j)
    ...
    function with many digits (good initial values are needed for convergence)::
        ...
        (0.5+14.134725141734693790457251983562j)
    ...
    **Multiple roots**
    ...
    necessary::
        ...
        x:     -9.888888888888888888889
        error: 0.1111111111111111111113
        converging slowly
        x:     -9.778900112233445566779
        error: 0.10998877665544332210964
        converging slowly
        x:     -9.67002233332199662166
        error: 0.10887777891144894511891
        converging slowly
        accelerating convergence
        x:     -9.562244329955107766896
        error: 0.1077780033668888547643
        converging slowly
        x:     0.9999999999999999921402
        error: 10.562244329955107759035
        x:     1.0

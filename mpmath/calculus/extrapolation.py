...
def nprod(ctx, f, interval, nsum=False, **kwargs):
    ...
    By default, :func:`nprod` uses the same extrapolation methods as
    :func:`nsum`, except applied to the partial products rather than
    partial sums, and the same keyword options as for :func:`nsum` are

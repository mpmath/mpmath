...
def test_ei():
    ...
    mp.dps = 50
    r = ei(20000)
    s = '3.878196282504501093027387008550181947069847697501875e+8681'
    assert str(r) == s
    r = ei(-200)
    s = '-6.88522610630763559771081748245579297383680869333025e-90'
    assert str(r) == s
    r =ei(20000 + 10*j)
    sre = '-3.25513823403206940249385063887441072596140127410596e+8681'
    sim = '-2.10819299934744035207859424294691876477673696454232e+8681'
...
def test_erf():
    ...
    mp.dps = 15
    assert str(erfc(10**50)) == '3.667448265325548e-4342944819032518276511289189166050822943970058036665661144537831658646492088707747292249493384317534'
    assert erfinv(0) == 0

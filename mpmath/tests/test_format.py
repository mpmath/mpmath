...
@given(st.floats(allow_nan=False, allow_infinity=False,
                 allow_subnormal=False),
       st.integers(min_value=1,  # see gmpy2/gmpy2#709
                   max_value=100),
       st.sampled_from(list('UDN')))
@example(0.0078125, 1, 'U')
# cases from issue 1131:
@example(0.6619127364342315, 21, 'N')
@example(0.6297105422352101, 21, 'U')
@example(0.6297105422352101, 21, 'Y')
@example(0.688196003332049, 15, 'U')
@example(0.688196003332049, 15, 'Y')
@example(0.723878758194723, 30, 'U')
@example(0.9613282696770447, 21, 'N')
@example(0.09235788595039773, 21, 'U')
@example(0.3298566560896268, 21, 'U')
@example(0.3588939646841417, 21, 'N')
@example(0.15440508559046828, 30, 'U')
@example(0.15440508559046828, 30, 'Y')
@example(0.9979397926282667, 30, 'U')
@example(0.9979397926282667, 30, 'Y')
@example(0.2220296499476513, 21, 'U')
@example(0.2220296499476513, 21, 'Y')
@example(0.6536399212616628, 30, 'U')
@example(0.6536399212616628, 30, 'Y')
@example(0.8530803285866565, 15, 'N')
@example(0.953156221025382, 15, 'U')
@example(0.953156221025382, 15, 'Y')
@example(0.5727345851984404, 30, 'U')
@example(0.5727345851984404, 30, 'Y')
@example(0.256323486957169, 15, 'U')
@example(0.256323486957169, 15, 'Y')
@example(0.7449555102928082, 21, 'U')
@example(0.7449555102928082, 21, 'Y')
@example(0.757432672656007, 15, 'U')
@example(0.757432672656007, 15, 'Y')
@example(0.5461206011142965, 15, 'N')
@example(0.6880031790198885, 15, 'N')
@example(0.4619503809800374, 21, 'N')
@example(0.7983721030385765, 30, 'N')
@example(0.368182506823722, 15, 'U')
@example(0.911407472467891, 15, 'U')
@example(0.32552591842684553, 21, 'U')
@example(0.8484447782422605, 15, 'N')
@example(0.639183687152169, 15, 'U')
@example(0.689165322021892, 21, 'U')
@example(0.403309087761342, 15, 'U')

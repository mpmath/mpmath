...
def test_bernoulli():
    ...
    assert str(bernoulli(10**100)) == '-2.58183325604736e+987675256497386331227838638980680030172857347883537824464410652557820800494271520411283004120790908423'
    mp.dps = 50
    ...
    assert str(bernoulli(10**5)) == '-5.8223525381387322109718142542038307938400075005058e+376745'
    assert str(bernoulli(10**8+2)) == '1.1957035145284240522328803157892147712077025377042e+676752568'
    assert str(bernoulli(10**100)) == '-2.5818332560473632073252488656039475548106223822913e+987675256497386331227838638980680030172857347883537824464410652557820800494271520411283004120790908423'
    mp.dps = 1000

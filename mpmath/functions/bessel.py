...
def besseljzero(ctx, v, m, derivative=0):
    ...
    **Examples**
    ...
    Initial zeros of the Bessel functions `J_0(z), J_1(z), J_2(z)`::
        ...
        2.40482555769577276862163187
        5.520078110286310649596604138
        8.653727912911012216954198753
        >>> besseljzero(1,1); besseljzero(1,2); besseljzero(1,3)
        3.831705970207512315614435863
        7.015586669815618753537050011
        10.17346813506272207718571185
        >>> besseljzero(2,1); besseljzero(2,2); besseljzero(2,3)
        5.135622301840682556301401679
        8.417244140399864857783613715
        11.61984117214905942709414505
    ...
    Initial zeros of `J'_0(z), J'_1(z), J'_2(z)`::
        ...
        1.841183781340659302643629503
        5.331442773525032636884016136
        8.536316366346285834358960939
        >>> besseljzero(2,1,1); besseljzero(2,2,1); besseljzero(2,3,1)
        3.054236928227140322755932072
        6.706133194158459146634394376
        9.969467823087595793179142705

    Zeros with large index::

        >>> besseljzero(0,100); besseljzero(0,1000); besseljzero(0,10000)
        313.3742660775278447196902419
        3140.807295225078628895545444
        31415.14114171350798533665751
        >>> besseljzero(5,100); besseljzero(5,1000); besseljzero(5,10000)
        321.1893195676003157339222051
        3148.657306813047523500494005
        31422.99472554862917989430188
        >>> besseljzero(0,100,1); besseljzero(0,1000,1); besseljzero(0,10000,1)
        311.8018681873704508125112435
        3139.236339643802482833973124
        31413.57032947022399485808224

    Zeros of functions with large order::

        >>> besseljzero(50,1)
        57.11689916011917411936227899
        >>> besseljzero(50,2)
        62.80769876483536093435393026
        >>> besseljzero(50,100)
        388.693660065605883464098073
        >>> besseljzero(50,1,1)
        52.99764038731665010944037053
        >>> besseljzero(50,2,1)
        60.02631933279942589882363053
        >>> besseljzero(50,100,1)
        387.1083151608726181086283376
    ...
    Zeros of functions with fractional order::
        ...
        4.493409457909064175307880968
        15.15657692957458622921633935
    ...
    products over their zeros::
        ...
        ...
        0.1149034849319004804696468815
        >>> besselj(v,z)
        0.1149034849319004804696468813
        >>> (z/2)**(v-1)/2/gamma(v) * \
        ...     nprod(lambda k: 1-(z/besseljzero(v,k,1))**2, [1,inf])
        ...
        0.2102436158811325550203884407
        >>> besselj(v,z,1)
        0.2102436158811325550203884407
...
def besselyzero(ctx, v, m, derivative=0):
    ...
    **Examples**
    ...
    Initial zeros of the Bessel functions `Y_0(z), Y_1(z), Y_2(z)`::
        ...
        0.8935769662791675215848871044
        3.95767841931485786837567719
        7.08605106030177269762362457
        >>> besselyzero(1,1); besselyzero(1,2); besselyzero(1,3)
        2.197141326031017035149033576
        5.429681040794135132772005183
        8.596005868331168926429606136
        >>> besselyzero(2,1); besselyzero(2,2); besselyzero(2,3)
        3.384241767149593472701426017
        6.793807513268267538291167159
        10.02347797936003797850539184
    ...
    Initial zeros of `Y'_0(z), Y'_1(z), Y'_2(z)`::
        ...
        3.683022856585177699898967226
        6.941499953654175655751943671
        10.12340465543661307978775267
        >>> besselyzero(2,1,1); besselyzero(2,2,1); besselyzero(2,3,1)
        5.00258293144606394520017575
        8.350724701413079526349713672
        11.57419546521764654624264511

    Zeros with large index::

        >>> besselyzero(0,100); besselyzero(0,1000); besselyzero(0,10000)
        311.8034717601871549333418897
        3139.236498918198006794026087
        31413.57034538691205229188486
        >>> besselyzero(5,100); besselyzero(5,1000); besselyzero(5,10000)
        319.618333856278215623506217
        3147.086508524556404473185563
        31421.42392920214673402828314
        >>> besselyzero(0,100,1); besselyzero(0,1000,1); besselyzero(0,10000,1)
        313.3726705426359345050449194
        3140.807136030340213610064655
        31415.14112579761578220174832

    Zeros of functions with large order::

        >>> besselyzero(50,1)
        53.50285882040036394680236631
        >>> besselyzero(50,2)
        60.11244442774058114686021804
        >>> besselyzero(50,100)
        387.1096509824943957706834849
        >>> besselyzero(50,1,1)
        56.96290427516751320063604809
        >>> besselyzero(50,2,1)
        62.7488816694593394403662264
        >>> besselyzero(50,100,1)
        388.692330054830925835547508

    Zeros of functions with fractional order::

        >>> besselyzero(0.5,1); besselyzero(1.5,1); besselyzero(2.25,4)
        1.570796326794896619231321701
        2.798386045783887136720248912
        13.56721208770735123376017714

...
def spherical_in(ctx, n, z):
    ...
    **Examples**
    ...
    mpc(real='-0.00275055208104304', imag='0.0033767606983784665')
...
def spherical_kn(ctx, n, z):
    ...
    **Examples**
    ...
    >>> spherical_kn(0, 1)
    mpf('0.5778636748954608')
    >>> spherical_kn(6, 0.5 + 3j)
    mpc(real='-8.661573678807862', imag='5.516580148442229')
...
def besseljzero(ctx, v, m, derivative=0):
    ...
    **Examples**
    ...
    Initial zeros of the Bessel functions `J_0(z), J_1(z), J_2(z)`::
        ...
        >>> besseljzero(0,2)
        5.5200781102863106495966041
        >>> besseljzero(0,3)
        8.6537279129110122169541988
        >>> besseljzero(1,1)
        3.83170597020751231561443586
        >>> besseljzero(1,2)
        7.01558666981561875353705
        >>> besseljzero(1,3)
        10.1734681350627220771857118
        >>> besseljzero(2,1)
        5.1356223018406825563014017
        >>> besseljzero(2,2)
        8.4172441403998648577836137
        >>> besseljzero(2,3)
        11.619841172149059427094145
    ...
    Initial zeros of `J'_0(z), J'_1(z), J'_2(z)`::
        ...
        7.01558666981561875353705
        >>> besseljzero(1,1,1)
        1.8411837813406593026436295
        >>> besseljzero(1,2,1)
        5.3314427735250326368840161
        >>> besseljzero(1,3,1)
        8.536316366346285834358961
        >>> besseljzero(2,1,1)
        3.05423692822714032275593207
        >>> besseljzero(2,2,1)
        6.7061331941584591466343944
        >>> besseljzero(2,3,1)
        9.9694678230875957931791427

    Zeros with large index::

        >>> besseljzero(0,100)
        313.37426607752784471969024
        >>> besseljzero(0,1000)
        3140.80729522507862889554544
        >>> besseljzero(0,10000)
        31415.1411417135079853366575
        >>> besseljzero(5,100)
        321.189319567600315733922205
        >>> besseljzero(5,1000)
        3148.657306813047523500494
        >>> besseljzero(5,10000)
        31422.994725548629179894302
        >>> besseljzero(0,100,1)
        311.801868187370450812511244
        >>> besseljzero(0,1000,1)
        3139.2363396438024828339731
        >>> besseljzero(0,10000,1)
        31413.5703294702239948580822

    Zeros of functions with large order::

        >>> besseljzero(50,1)
        57.116899160119174119362279
        >>> besseljzero(50,2)
        62.80769876483536093435393
        >>> besseljzero(50,100)
        388.69366006560588346409807
        >>> besseljzero(50,1,1)
        52.9976403873166501094403705
        >>> besseljzero(50,2,1)
        60.0263193327994258988236305
        >>> besseljzero(50,100,1)
        387.10831516087261810862834
    ...
    products over their zeros::
        ...
        ...
        0.114903484931900480469646882
        >>> besselj(v,z)
        0.114903484931900480469646882
        >>> (z/2)**(v-1)/2/gamma(v) * \
        ...     nprod(lambda k: 1-(z/besseljzero(v,k,1))**2, [1,inf])
        ...
        0.21024361588113255502038844
        >>> besselj(v,z,1)
        0.21024361588113255502038844
...
def besselyzero(ctx, v, m, derivative=0):
    ...
    **Examples**
    ...
    Initial zeros of the Bessel functions `Y_0(z), Y_1(z), Y_2(z)`::
        ...
        >>> besselyzero(0,2)
        3.9576784193148578683756772
        >>> besselyzero(0,3)
        7.0860510603017726976236246
        >>> besselyzero(1,1)
        2.1971413260310170351490336
        >>> besselyzero(1,2)
        5.4296810407941351327720052
        >>> besselyzero(1,3)
        8.5960058683311689264296061
        >>> besselyzero(2,1)
        3.384241767149593472701426
        >>> besselyzero(2,2)
        6.7938075132682675382911672
        >>> besselyzero(2,3)
        10.0234779793600379785053918
    ...
    Initial zeros of `Y'_0(z), Y'_1(z), Y'_2(z)`::
        ...
        8.5960058683311689264296061
        >>> besselyzero(1,1,1)
        3.68302285658517769989896723
        >>> besselyzero(1,2,1)
        6.9414999536541756557519437
        >>> besselyzero(1,3,1)
        10.1234046554366130797877527
        >>> besselyzero(2,1,1)
        5.0025829314460639452001758
        >>> besselyzero(2,2,1)
        8.3507247014130795263497137
        >>> besselyzero(2,3,1)
        11.5741954652176465462426451

    Zeros with large index::

        >>> besselyzero(0,100)
        311.80347176018715493334189
        >>> besselyzero(0,1000)
        3139.2364989181980067940261
        >>> besselyzero(0,10000)
        31413.570345386912052291885
        >>> besselyzero(5,100)
        319.61833385627821562350622
        >>> besselyzero(5,1000)
        3147.08650852455640447318556
        >>> besselyzero(5,10000)
        31421.423929202146734028283
        >>> besselyzero(0,100,1)
        313.37267054263593450504492
        >>> besselyzero(0,1000,1)
        3140.80713603034021361006465
        >>> besselyzero(0,10000,1)
        31415.1411257976157822017483

    Zeros of functions with large order::

        >>> besselyzero(50,1)
        53.502858820400363946802366
        >>> besselyzero(50,2)
        60.112444427740581146860218
        >>> besselyzero(50,100)
        387.109650982494395770683485
        >>> besselyzero(50,1,1)
        56.962904275167513200636048
        >>> besselyzero(50,2,1)
        62.748881669459339440366226
        >>> besselyzero(50,100,1)
        388.69233005483092583554751
    ...
    Zeros of functions with fractional order::
        ...
        >>> besselyzero(1.5,1)
        2.7983860457838871367202489
        >>> besselyzero(2.25,4)
        13.5672120877073512337601771

    ...
    if n:
        if n == 1:
            def h():
                ...
                # http://functions.wolfram.com/03.07.26.0001.01
                    ...
                    C2 = _airyai_C2(ctx)
                    T1 = [C1,z],[1,2],[],[],[],[ctx._mpq_5_3],w
                    T2 = [C2],[1],[],[],[],[ctx._mpq_1_3],w
                    return T1, T2
            ...
            def h(n):
                ...
                w = z**3/9
                ctx.prec -= extraprec
                q13,q23,q43 = ctx._mpq_1_3, ctx._mpq_2_3, ctx._mpq_4_3
        ...
        def h():
            if ctx._re(z) > 4:
                ...
                C1 = _airyai_C1(ctx)
                C2 = _airyai_C2(ctx)
                T1 = [C1],[1],[],[],[],[ctx._mpq_2_3],w
                T2 = [z*C2],[1],[],[],[],[ctx._mpq_4_3],w
                return T1, T2
        return ctx.hypercomb(h, [], **kwargs)
...
def _scorer(ctx, z, which, kwargs):
    ...
    def h():
        ...
        ctx.prec -= extraprec
        T1 = [A], [1], [], [], [], [], 0
        T2 = [B,z], [-1,2], [], [], [1], [ctx._mpq_4_3,ctx._mpq_5_3], w
        return T1, T2
    return ctx.hypercomb(h, [], **kwargs)

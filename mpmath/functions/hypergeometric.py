...
def hyper2d(ctx, a, b, x, y, **kwargs):
    ...
    **Examples**
    ...
    product of two Gaussian hypergeometric functions::
        ...
        >>> hyper2d({'m':1,'n':1}, {}, x,y)
        2.666666666666666666666666684
        >>> 1/(1-x)/(1-y)
        2.666666666666666666666666684
        >>> hyper2d({'m':[1,2],'n':[3,4]}, {'m':[5],'n':[6]}, x,y)
        4.164358531238938319669855789
...
def bihyper(ctx, a_s, b_s, z, **kwargs):
    ...
    **Examples**
    ...
    sum of one `\,_2F_0` function and one `\,_1F_1` function::
        ...
        >>> z = mpf(0.75)
        >>> bihyper([a], [], z)
        (0.2454393389657273841385581902 + 0.2454393389657273841385581902j)
        >>> hyper([a,1],[],z) + (hyper([1],[1-a],-1/z)-1)
        (0.2454393389657273841385581837 + 0.2454393389657273841385581902j)
        >>> hyper([a,1],[],z) + hyper([1],[2-a],-1/z)/z/(a-1)
        (0.2454393389657273841385581966 + 0.2454393389657273841385581902j)

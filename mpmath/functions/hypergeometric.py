...
def bihyper(ctx, a_s, b_s, z, *, eliminate=True, eliminate_all=False,
    ...
    **Examples**
    ...
    sum of one `\,_2F_0` function and one `\,_1F_1` function::
        ...
        >>> z = mpf(0.75)
        >>> bihyper([a], [], z)
        (0.24543933896572738413855819+0.24543933896572738413855819j)
        >>> hyper([a,1],[],z) + (hyper([1],[1-a],-1/z)-1)
        (0.245439338965727384138558184+0.24543933896572738413855819j)
        >>> hyper([a,1],[],z) + hyper([1],[2-a],-1/z)/z/(a-1)
        (0.245439338965727384138558197+0.24543933896572738413855819j)
